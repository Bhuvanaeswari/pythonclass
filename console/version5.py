from controller_version5 import *
            ...
            if choice == 1 :
                ...
                if based == "key" :
                    ...
                    try:
                        ...
                        print(ve,"employees must be in wholenumber and salary,ratings can be either fractional number")    
               ...
               if based == "key":
                    ...
                    #dir1 * [input("enter the org short form  : "),corporate()]
                     ...
                     try:
                         ...
                         print(ve," value must be in fractional number")    
                         dir1 * ["",corporate(rate=float(input("enter the ratings : " )))]
